 ...
 */
public class ValidateModel implements ValidateModelImpl{

    private MainActivity view;

    @Override
    public void checkLogin(final MainActivity view, final ValidatePresenter validatePresenter) {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    if(pwd.equals(unique_pwd) && !input_pwd.equals("")){
                        ...
                        if(i < ValidatePresenter.maxErrorPwdTime){
    ...
    @Override
    public void setupPassword(final MainActivity view, final ValidatePresenter validatePresenter){
        ...
        dialog.setOnPositiveListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pwd1.equals(pwd2) && !pwd1.equals("")) {
                    try {
                        String pwd = SimpleCrypto.enCrypto(pwd1, "bdpq_unique_pwd");
                        PrefUtils.setUniquePwd(pwd);
                        PrefUtils.setFirstOpen(false);
                        dialog.dismiss();
                        Toast.makeText(view,"设置成功,请牢记唯一的密码",Toast.LENGTH_LONG).show();
                    ...
                    //密码输入不一致
                    Toast.makeText(view,"两次密码输入不一致，请重新输入",Toast.LENGTH_SHORT).show();
                }
            }
        });
        dialog.setOnNegativeListener(new View.OnClickListener() {
