...
import com.example.chen.memo.model.ValidateModel;
 ...
 */
public class ValidatePresenter implements ValidatePresenterImpl {


    private NextActivity nextActivity;
    private MainActivity view;
    private ValidateModel validateModel = new ValidateModel();
